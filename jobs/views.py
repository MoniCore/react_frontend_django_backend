...
def jobdashboard(request):
    ...
    return render(request,'jobs/dashboard.html',{'curuser':curuser}) 
def userjobs(request):
    ...
    return render(request,'jobs/userjobs.html',{'curuser':curuser}) 
...
def view_job_detail(request,job_id):
    try:
        ...
        return render(request,'jobs/details.html',{'job':data,'curuser':curuser})
    except:
