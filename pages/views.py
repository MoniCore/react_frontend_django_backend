...
from account.views import check_auth 
...
def create(request):
    ...
    return render(request,'pages/create.html',{'users':users,'users_for_invite':users_for_invite,'curuser':curuser}) 
...
def view_page_detail(request,page_id):
    ...
    if cur_temp.avatar:
        ...
        cur_page['back'] = '/static/images/no_banner.png'
    ...
    if this_user.avatar:
        ...
        cur_page['avatar'] = '/static/images/avatar.png'
    ...
    return render(request,'pages/details.html',{'users':users,'users_for_invite':users_for_invite,'curuser':curuser,'cur_page':cur_page,'pages':allpages}) 
